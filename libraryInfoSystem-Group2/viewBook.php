            ...
            <div class="col">
				...
				<td style="width: 20%"> No. of copy </td>
				    ...
				    <td><?php echo $data['NoOfCopy'] ?></td>
                                    <td><a href="editBook.php?U_ID=<?php echo $data['ISBN'] ?>" class="btn btn-success">Edit</a></td>
                                    <td><a href="delBook.php?D_ID=<?php echo $data['ISBN'] ?>" class="btn btn-danger">Delete</a></td>
                            </tr>
                            <?php
                                    }
                                ?>
